...
import MakimaRobot.modules.sql.global_bans_sql as gban_sql
import MakimaRobot.modules.sql.users_sql as user_sql
from MakimaRobot import DEV_USERS, OWNER_ID, dispatcher
