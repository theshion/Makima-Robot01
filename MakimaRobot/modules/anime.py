...
from MakimaRobot import DEV_USERS, DRAGONS, OWNER_ID, dispatcher
...
def anime(update: Update, context: CallbackContext):
    ...
    if len(search) == 1:
        update.effective_message.reply_video(
            video="https://telegra.ph/file/1720638815298f5305519.mp4",
...
def manga(update: Update, context: CallbackContext):
    ...
    if len(search) == 1:
        update.effective_message.reply_video(
            video="https://telegra.ph/file/620ad309c69818d249e63.mp4",
