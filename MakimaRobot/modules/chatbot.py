...
import MakimaRobot.modules.sql.chatbot_sql as sql
from MakimaRobot import dispatcher
from MakimaRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from MakimaRobot.modules.helper_funcs.filters import CustomFilters
from MakimaRobot.modules.log_channel import gloggable
...
def kuki(update: Update, context: CallbackContext):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(text="𝙀𝙉𝘼𝘽𝙇𝙀 ✅", callback_data="add_chat({})")],
            [InlineKeyboardButton(text="𝘿𝙄𝙎𝘼𝘽𝙇𝙀 ❌", callback_data="rm_chat({})")],
        ]
    )
    message.reply_text(
        msg,
