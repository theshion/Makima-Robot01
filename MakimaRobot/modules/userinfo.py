...
import MakimaRobot.modules.sql.userinfo_sql as sql
...
from MakimaRobot import telethn as MakimaTelethonClient
from MakimaRobot.__main__ import STATS, TOKEN, USER_INFO
from MakimaRobot.modules.disable import DisableAbleCommandHandler
from MakimaRobot.modules.helper_funcs.chat_status import sudo_plus
from MakimaRobot.modules.helper_funcs.extraction import extract_user
from MakimaRobot.modules.sql.afk_sql import check_afk_status, is_afk
from MakimaRobot.modules.sql.global_bans_sql import is_user_gbanned
from MakimaRobot.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/kakashi_bots_updates/11"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/kakashi_bots_updates/14"
                            ),
                        ],
                    ]
                ),
